...
import com.example.kts_android_09_2021.fragments.profile_fragment.user_photos_fragment.UserPhotosFragmentAdapter
...
class LikedPhotosFragment : Fragment(R.layout.fragment_user_photos) {
    ...
    private fun deleteLoadingItem() {
        userPhotosAdapter.items =
            userPhotosAdapter.items.toMutableList().apply {
